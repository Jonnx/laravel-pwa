...
<div x-cloak x-data="manualInstallBanner" x-show="show" class="bg-yellow-600 text-white px-4 py-3 flex items-center justify-between z-50 shadow-lg">
    <span>
        <strong>Install this app manually</strong> for a better experience!
        <template x-if="isIos()">
